...
export default function GlobalError({
  ...
  useEffect(() => {
    // Hatayı loglama servisine gönderebilirsiniz (örneğin Sentry)
      ...
      <body>
        <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
          <div className="bg-white p-8 rounded-2xl shadow-xl max-w-lg w-full text-center border border-gray-100">
            ...
            <h1 className="text-2xl font-bold text-gray-900 mb-2">Kritik Bir Sistem Hatası</h1>
            <p className="text-gray-500 mb-8">
              Sistemin temel yapısında beklenmeyen bir sorun oluştu. Merak etmeyin, verileriniz güvende. Sayfayı yenileyerek tekrar deneyebilirsiniz.
            </p>
